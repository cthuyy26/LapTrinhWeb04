    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        try {
            ...
            if (product != null) {
                ...
                if (priceStr != null) product.setPrice(Double.parseDouble(priceStr));
                if (quantityStr != null) product.setQuantity(Integer.parseInt(quantityStr));
                if (statusStr != null) product.setStatus(Integer.parseInt(statusStr));
