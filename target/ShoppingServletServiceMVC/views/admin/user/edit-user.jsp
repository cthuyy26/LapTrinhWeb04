...
<div class="form-card">
    <div class="form-header">
        <h3><i class="fa fa-pencil-square-o" style="color: #0284c7;"></i> Chỉnh Sửa Thông Tin Người Dùng #${user.id}</h3>
    </div>
    ...
    <div class="form-body">
        <form action="${pageContext.request.contextPath}/admin/user/edit" method="post" enctype="multipart/form-data">
            ...
            <div class="avatar-preview-box">
                <img id="avatarPreview" src="${pageContext.request.contextPath}/image?fname=${not empty user.avatar ? user.avatar : 'default'}" alt="Avatar Preview" class="avatar-preview-img" />
                <div>
            ...
            <div class="row">
                <div class="col-md-6 form-group" style="margin-bottom: 20px;">
                    <label class="form-label"><i class="fa fa-user"></i> Tên tài khoản (Username)</label>
                    <input type="text" class="form-control-custom" value="${user.userName}" readonly disabled />
                </div>

                <div class="col-md-6 form-group" style="margin-bottom: 20px;">
                    <label class="form-label" for="password"><i class="fa fa-lock"></i> Đổi mật khẩu mới (Tùy chọn)</label>
                    <input type="password" id="password" name="password" class="form-control-custom" placeholder="Để trống nếu giữ nguyên..." />
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-md-6 form-group" style="margin-bottom: 20px;">
                    ...
                    <input type="text" id="fullname" name="fullname" class="form-control-custom" value="${user.fullName}" required />
                </div>

                <div class="col-md-6 form-group" style="margin-bottom: 20px;">
                    <label class="form-label" for="email"><i class="fa fa-envelope"></i> Địa chỉ Email <span style="color: #ef4444;">*</span></label>
                    <input type="email" id="email" name="email" class="form-control-custom" value="${user.email}" required />
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-md-6 form-group" style="margin-bottom: 25px;">
                    ...
                    <input type="tel" id="phone" name="phone" class="form-control-custom" value="${user.phone}" placeholder="Nhập số điện thoại..." />
                </div>
